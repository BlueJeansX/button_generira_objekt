...
function createPolaznik() {
   ...
   switch (imena[random]) {
      ...
      case "Bruno":
         ...
         break;
      case "Nader":
         let polaznik6 = new Polaznik('Nader', 'Naderovo prezime')
         p.innerHTML = polaznik6.ime + polaznik6.prezime;
         break;
      case "Antonija":
         let polaznik7 = new Polaznik('Antonija', 'Ne znamp prezime')
         p.innerHTML = polaznik7.ime + polaznik7.prezime;
         break;
      case "Mladen":
         let polaznik8 = new Polaznik('Mladen', 'Moram još staviti razmak nakon imena')
